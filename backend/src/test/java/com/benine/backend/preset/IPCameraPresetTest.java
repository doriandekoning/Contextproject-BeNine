...
public class IPCameraPresetTest extends PresetTest {
  ...
  public IPCameraPreset getPreset() {
    IPCameraPreset preset = new IPCameraPreset(new ZoomPosition(4.2, 42.42, 4), new FocusValue(2, false), 5, true, 34);
    preset.setName("name");
    return preset;
  }
  ...
  public void setup() {
    ...
    keywords.add("foo");
    preset = new IPCameraPreset(new ZoomPosition(10, 12, 13), new FocusValue(40, true), 56, false, 0);
    preset.setName("name");
  ...
  public void testHashCodefalse() {
    Set<String> keywords = new HashSet<>();
    keywords.add("foo");
    Preset preset2 = new IPCameraPreset(new ZoomPosition(10, 12, 13), new FocusValue(40, true), 56, false, 0);
  ...
  public void testEqualsDifferentCameraId() {
    IPCameraPreset preset = new IPCameraPreset(new ZoomPosition(0, 0, 0), new FocusValue(0, false), 0, false, 0);
    IPCameraPreset preset2 = new IPCameraPreset(new ZoomPosition(0, 0, 0), new FocusValue(0, false), 0, false, 1);
    Assert.assertNotEquals(preset, preset2);
  }
  ...
  public void testEqualsSamePreset() {
    IPCameraPreset preset = new IPCameraPreset(new ZoomPosition(0, 0, 0), new FocusValue(0, false), 0, false, 0);
    IPCameraPreset preset2 = new IPCameraPreset(new ZoomPosition(0, 0, 0), new FocusValue(0, false), 0, false, 0);
