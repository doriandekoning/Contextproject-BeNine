...
public class PresetsHandlerTest extends RequestHandlerTest {
  ...
  public void initialize() throws IOException, JSONException, CameraBusyException {
    ...
    Preset preset = new IPCameraPreset(new ZoomPosition(1, 1, 1), new FocusValue(1, true), 1, true, 0);
    preset.setName("name");
    Set<String> keywords = new HashSet<>();
    keywords.add("Violin");
    Preset presetKeywords = new IPCameraPreset(new ZoomPosition(1, 1, 1), new FocusValue(1, true), 1, true, 0);
